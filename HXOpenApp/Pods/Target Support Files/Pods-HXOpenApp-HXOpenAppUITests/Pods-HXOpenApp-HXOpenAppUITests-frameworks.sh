...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BBMainProject/BBMainProject.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ReactiveAFNetworking/ReactiveAFNetworking.framework"
